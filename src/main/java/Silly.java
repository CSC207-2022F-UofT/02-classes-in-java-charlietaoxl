...
public class Silly implements Comparable<Silly>{
     ...
     */
    /**
     * Creates new Silly object
     * This constructor takes in two Strings as the arguments and concatenates them together.
     *
     * @param first parameter to take in the first string
     * @param last parameter to take in the second string
     */
